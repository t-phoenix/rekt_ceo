...
export default function Roadmap(){
    return(
        ...
        <div className="roadmap-box">
          ...
          <div
            style={{ backgroundImage: `url(${bioluminescent.src})` }}
            className="roadmap-card road-2"
          >
            <h1>2. MINT PFP</h1>
          </div>
          <div
            style={{ backgroundImage: `url(${cyber_forest.src})` }}
          ...
          <div
            style={{
              backgroundImage: `url(${floating_garden.src})`,
          ...
          <div
            style={{ backgroundImage: `url(${neon_mist.src})` }}
          ...
          <div
            style={{
              backgroundImage: `url(${waterfall_garden.src})`,
          ...
          <div
            style={{
              backgroundImage: `url(${cyber_forest.src})`,
              backgroundPosition: "bottom",
            }}
