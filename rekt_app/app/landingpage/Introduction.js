  ...
  return (
    <div>
      ...
      >
        ...
        <Image src={ambassador} alt="ambassador" className="ambassador-image" />
      </section>
      ...
      <section id="faq" className="faq-section">
        ...
        <div className="link-container">
            ...
            <div className="link-icon-box">
                <Image className="link-icon-image" src={pumpfun} alt="pump fun" />
            </div>
            <div className="link-icon-box">
                <Image className="link-icon-image" src={raydium} alt="pump fun" />
            </div>
        </div>
