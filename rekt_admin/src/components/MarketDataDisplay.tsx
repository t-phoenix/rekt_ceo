    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-lg p-4">
          <div className="text-sm text-indigo-600 mb-1">CEO Price</div>
          <div className="text-2xl font-bold text-indigo-900">
            {formatPrice(poolPriceData.priceCEO, { prefix: '$', maxDecimals: 6 })}
          </div>
          <div className="text-xs text-indigo-600 mt-1">per CEO token</div>
        </div>

        {/* USDC Price */}
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-4">
          <div className="text-sm text-blue-600 mb-1">USDC Price</div>
          <div className="text-2xl font-bold text-blue-900">
            {formatTokenAmount(poolPriceData.priceUSDC, { maxDecimals: 6 })}
          </div>
          <div className="text-xs text-blue-600 mt-1">CEO per USDC</div>
        </div>

        {/* Total Liquidity */}
        <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-4">
          <div className="text-sm text-green-600 mb-1">Total Liquidity</div>
          <div className="text-2xl font-bold text-green-900">
            {formatCurrency(poolPriceData.liquidityUSD, { compact: true })}
          </div>
          <div className="text-xs text-green-600 mt-1">in pool</div>
        </div>

        {/* 24h Volume */}
        <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg p-4">
          <div className="text-sm text-purple-600 mb-1">24h Volume</div>
          <div className="text-2xl font-bold text-purple-900">
            {formatCurrency(poolPriceData.volume24h, { compact: true })}
          </div>
          <div className="text-xs text-purple-600 mt-1">trading volume</div>
        </div>
      </div>
      ...
      <div className="mt-6 pt-6 border-t border-gray-200">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-gray-50 rounded-lg p-4">
            ...
            <div className="text-xs text-gray-500 mt-1">0.3% of volume</div>
          </div>
          <div className="bg-gray-50 rounded-lg p-4">
            <div className="text-sm text-gray-600 mb-1">Pool Fee</div>
            <div className="text-xl font-semibold text-gray-900">0.3%</div>
            <div className="text-xs text-gray-500 mt-1">per swap</div>
          </div>
        </div>
      </div>
      ...
      {poolData && !poolDataLoading && (
        <div className="mt-6 pt-6 border-t border-gray-200">
          <div className="text-sm font-medium text-gray-700 mb-3">Pool Information</div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-gray-50 rounded-lg p-4">
              <div className="text-sm text-gray-600 mb-1">Total LP Supply</div>
              <div className="text-lg font-semibold text-gray-900">
                {formatTokenAmount(poolData.totalSupply, { maxDecimals: 4 })}
              </div>
            </div>
            <div className="bg-gray-50 rounded-lg p-4">
              <div className="text-sm text-gray-600 mb-1">CEO Reserve</div>
              <div className="text-lg font-semibold text-gray-900">
                {formatTokenAmount(poolData.reserve0, { symbol: 'CEO', maxDecimals: 18 })}
              </div>
            </div>
            <div className="bg-gray-50 rounded-lg p-4">
              <div className="text-sm text-gray-600 mb-1">USDC Reserve</div>
              <div className="text-lg font-semibold text-gray-900">
